...
const serviceSchema = {
  ...
  "@type": "Service",
  "name": "Commercial Chain Link Fence Installation",
  "description": "Professional commercial and industrial chain link fence installation throughout Metro Atlanta and Georgia.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Chain Link Security Gates &amp; Fence Installations — Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Project photos from commercial and industrial chain link fence and gate installations throughout Metro Atlanta and Georgia.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { src: '/images/black-chain-link-double-swing-gate-atlanta-ga.jpg', alt: 'Black chain link double swing gate installation in Atlanta, GA' },
              { src: '/images/chain-link-double-swing-gate-commercial-georgia.jpg', alt: 'Commercial chain link double swing gate at property entrance in Georgia' },
              ...
              { src: '/images/chain-link-double-gate-walk-gate-georgia.jpg', alt: 'Chain link double gate with pedestrian walk gate in Georgia' },
              { src: '/images/chain-link-cantilever-gate-installation-atlanta-ga.jpg', alt: 'Chain link cantilever slide gate installation in Atlanta, GA' },
              ...
              { src: '/images/commercial-chain-link-slide-gate-warehouse-atlanta-ga.jpg', alt: 'Commercial chain link slide gate at warehouse in Atlanta, GA' },
              { src: '/images/chain-link-slide-gate-operator-barbed-wire-georgia.jpg', alt: 'Chain link slide gate with gate operator and barbed wire in Georgia' },
              { src: '/images/chain-link-security-fence-barbed-wire-bollards-georgia.jpg', alt: 'Commercial chain link security fence with barbed wire and bollards in Georgia' },
              { src: '/images/commercial-chain-link-perimeter-fence-barbed-wire-georgia.jpg', alt: 'Commercial chain link perimeter fence with barbed wire in Georgia' },
              { src: '/images/industrial-chain-link-fence-barbed-wire-installation-georgia.jpg', alt: 'Industrial chain link fence with barbed wire installation in Georgia' },
              ...
              { src: '/images/black-chain-link-security-fence-gate-commercial-georgia.jpg', alt: 'Black chain link security fence and gate at commercial property in Georgia' },
              { src: '/images/black-chain-link-swing-gate-operator-bollards-georgia.jpg', alt: 'Black chain link swing gate with operator and yellow bollards in Georgia' },
              { src: '/images/black-chain-link-cantilever-gate-operator-atlanta-ga.jpg', alt: 'Black chain link cantilever gate with gate operator and bollards in Atlanta, GA' },
              { src: '/images/chain-link-swing-gate-self-storage-georgia.jpg', alt: 'Chain link swing gate at self-storage facility in Georgia' },
            ].map((photo) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Commercial property owners, general contractors, and facility managers throughout Georgia rely on Fence Workshop for heavy-duty chain link installation.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: "We needed a 600-foot perimeter fence around our distribution yard on a tight deadline. Fence Workshop showed up on time, finished ahead of schedule, and the work passed inspection without a single issue.", name: "Derek H.", role: "Facilities Director, Duluth GA" },
              { quote: "We've used other fence companies before. Nobody matches Fence Workshop on commercial chain link. The posts are set right, the tension is right, the gates swing and latch perfectly. It's the little things that show you're dealing with professionals.", name: "Maria K.", role: "General Contractor, Atlanta GA" },
              { quote: "Our school district needed new perimeter fencing at two campuses before the start of the school year. Fence Workshop coordinated the schedule, pulled the permits, and delivered on both sites. Exactly what we needed.", name: "Robert W.", role: "Director of Facilities, Gwinnett County GA" },
            ].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every commercial chain link installation we complete is backed by our workmanship guarantee. If posts settle, tension fails, or gates stop operating correctly, we come back and fix it — no charge. We&rsquo;ve been doing this for 15+ years and our reputation depends on installations that hold up.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link href="/installation/georgia/atlanta-fence-installation/" className="block text-brand-orange hover:underline font-medium">&rarr; Chain Link Fence Installation in Atlanta, GA</Link>
                <Link href="/installation/georgia/marietta-fence-installation/" className="block text-brand-orange hover:underline font-medium">&rarr; Chain Link Fence Installation in Marietta, GA</Link>
                <Link href="/installation/georgia/alpharetta-fence-installation/" className="block text-brand-orange hover:underline font-medium">&rarr; Chain Link Fence Installation in Alpharetta, GA</Link>
                <Link href="/installation/georgia/chain-link-fence-repair/" className="block text-brand-orange hover:underline font-medium">&rarr; Chain Link Fence Repair in Georgia</Link>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <QuoteForm subject="Commercial Chain Link Fence Quote" />
            </div>
          </div>
        </div>
      </section>
