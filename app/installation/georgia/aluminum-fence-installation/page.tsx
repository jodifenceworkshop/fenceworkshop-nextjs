...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Aluminum Fence Installation in Georgia', item: 'https://fenceworkshop.com/installation/georgia/aluminum-fence-installation/' },
  ],
}
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Aluminum Fence Installation in Georgia",
  "description": "Commercial aluminum fence installation throughout Metro Atlanta and Georgia — black aluminum, ornamental, spear-top, and flat-top styles. Licensed and insured with 15+ years experience.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
  ...
  "serviceType": "Ornamental Aluminum Fence Installation"
}
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Is aluminum fence a good alternative to wrought iron fence?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes — for most commercial and residential applications in Georgia, aluminum fence is a better choice than wrought iron. Aluminum delivers the same classic ornamental look as wrought iron (spear-top pickets, decorative rails, matching gates) at a lower cost and with far less maintenance. Wrought iron requires periodic painting and rust treatment, especially in Georgia's humid climate. Aluminum is rust-free, powder-coated, and holds its finish for decades with no upkeep. We install both aluminum and wrought iron fencing and can help you choose based on your project requirements and budget. Call (404) 314-4419 for a free quote."
      }
    }
  ]
}
...
export const metadata: Metadata = {
  title: 'Aluminum Fence Installation Georgia | Black Aluminum & Ornamental Fencing',
  description: 'Aluminum fence installation for commercial properties throughout Metro Atlanta and Georgia. Black aluminum, ornamental, and wrought iron style fencing. Licensed & insured. Free quotes — (404) 314-4419.',
  alternates: { canonical: 'https://fenceworkshop.com/installation/georgia/aluminum-fence-installation/' },
}
...
const faqs = [
  ...
  {
    question: 'Is aluminum fence a good alternative to wrought iron fence?',
    answer: 'Yes — for most commercial and residential applications in Georgia, aluminum fence is a better choice than wrought iron. Aluminum delivers the same classic ornamental look as wrought iron (spear-top pickets, decorative rails, matching gates) at a lower cost and with far less maintenance. Wrought iron requires periodic painting and rust treatment, especially in Georgia\'s humid climate. Aluminum is rust-free, powder-coated, and holds its finish for decades with no upkeep. We install both aluminum and wrought iron fencing and can help you choose based on your project requirements and budget. Call (404) 314-4419 for a free quote.',
  },
]
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
              ...
              <span>/</span>
              <span className="text-gray-200">Aluminum Fence Installation</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 leading-tight">
              Aluminum Fence Installation in Georgia
            </h1>
            <p className="text-2xl md:text-3xl font-bold text-brand-orange mb-6 leading-tight">
              Black Aluminum, Ornamental &amp; Wrought Iron Style Fencing
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Ornamental Aluminum Fence Projects in Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Custom ornamental aluminum fencing, gates, and railings installed throughout Metro Atlanta and Georgia.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { src: '/images/black-ornamental-arched-gate-granite-pillars-georgia.jpg', alt: 'Black ornamental arched gate with granite pillars in Georgia' },
              { src: '/images/black-ornamental-fence-curved-brick-pathway-georgia.jpg', alt: 'Black ornamental fence along curved brick pathway in Georgia' },
              { src: '/images/black-ornamental-railing-ring-pattern-corridor-georgia.jpg', alt: 'Black ornamental railing with ring pattern along commercial corridor in Georgia' },
              { src: '/images/black-ornamental-gate-ring-pattern-access-control-georgia.jpg', alt: 'Black ornamental gate with ring pattern and access control in Georgia' },
              { src: '/images/black-ornamental-gate-staircase-apartment-georgia.jpg', alt: 'Black ornamental gate at apartment entrance with staircase in Georgia' },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">HOA boards, commercial property owners, and landscape contractors throughout Metro Atlanta trust Fence Workshop for ornamental aluminum fence installation.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: "We replaced our old wrought iron fence with ornamental aluminum across our entire HOA entrance. Fence Workshop matched the original design exactly and the new fence looks better than the original. Our residents love it.", name: "Patricia L.", role: "HOA Board President, Alpharetta GA" },
              { quote: "We needed aluminum fencing around our commercial pool and adjacent property — about 400 feet. Fence Workshop handled the permit, confirmed the pool code requirements, and installed perfectly. Zero issues on inspection.", name: "Michael D.", role: "Property Manager, Sandy Springs GA" },
              { quote: "I've used Fence Workshop on three commercial projects now. The ornamental aluminum work is consistently excellent — clean welds, perfect alignment, and they always clean up the site when they're done.", name: "Jennifer C.", role: "Commercial Landscaper, Marietta GA" },
            ].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every ornamental aluminum fence we install is backed by our workmanship guarantee. If any section shifts, a post settles, or a gate stops operating correctly, we come back and make it right. Ornamental aluminum should look great and function perfectly for decades — we install it to last.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">We install commercial ornamental fencing throughout <Link href="/installation/georgia/atlanta-fence-installation/" className="text-brand-orange hover:underline">Metro Atlanta</Link> and across Georgia for commercial properties, municipalities, and general contractors. Ornamental fencing pairs well with our <Link href="/installation/georgia/security-gate-systems/" className="text-brand-orange hover:underline">security gate systems</Link> for a complete, polished perimeter solution.</p>
              ...
              <div className="space-y-3">
                ...
                <Link href="/installation/georgia/fence-repair/" className="block text-brand-orange hover:underline font-medium">&rarr; Commercial Fence Repair Services in Georgia</Link>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <QuoteForm subject="Ornamental Aluminum Fence Quote" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Aluminum Fence Installation — Frequently Asked Questions</h2>
          </div>
