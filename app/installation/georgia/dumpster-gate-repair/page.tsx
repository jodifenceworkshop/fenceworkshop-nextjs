...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Commercial Dumpster Gate Repair",
  "description": "Fast repair for broken hinges, sagging gates, latch failure, and frame damage on commercial dumpster enclosures throughout Metro Atlanta and Georgia.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
  ...
  "serviceType": "Dumpster Gate Repair"
}
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto"><div className="aspect-[16/7] relative bg-gray-200"><Image src="/images/dumpster-gate-repair-atlanta-ga.jpg" alt="Commercial dumpster gate repair by Fence Workshop in Georgia" fill className="object-cover" /></div></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">What Property Managers Say</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">We handle dumpster gate repair for commercial properties, HOAs, and multi-family communities across Metro Atlanta.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "Got a code enforcement notice on a Friday afternoon about our dumpster gate. Fence Workshop was on-site Monday morning and had it fixed same day. That kind of response time is hard to find.",
                name: "Rachel M.",
                role: "Property Manager, Smyrna GA"
              },
              {
                quote: "We have 8 properties in the Atlanta area and Fence Workshop handles dumpster gate repairs for all of them. Fast, reliable, and they know what they're doing. No need to call around for quotes.",
                name: "David P.",
                role: "Multi-Family Portfolio Manager, Atlanta"
              },
              {
                quote: "The waste hauler completely destroyed our gate hinges. Fence Workshop came out, diagnosed the issue, and recommended we add bollards to prevent it from happening again. Smart advice — saved us money long-term.",
                name: "Teresa H.",
                role: "Facilities Manager, Decatur GA"
              },
            ].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every repair we complete is backed by our workmanship guarantee. We test the gate before we leave — proper swing, latch, and closure. If the repair doesn&rsquo;t hold, we come back and make it right at no charge. No runaround, no excuses.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="text-center mb-12"><p className="text-brand-orange font-semibold uppercase tracking-wide mb-2">Related Services</p><h2 className="text-4xl font-bold text-gray-900 mb-4">Other Commercial Fence &amp; Gate Services</h2><p className="text-lg text-gray-700 max-w-3xl mx-auto">Need more than a repair? We handle full installations and other commercial fence services.</p></div><div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          { title: 'Bollard Installation', description: 'Bollards installed around dumpster enclosures protect gate hinges, posts, and walls from waste hauler damage — reducing future repair calls significantly.', href: '/installation/georgia/bollard-installation/' },
      ...
      <section id="quote" className="py-20 bg-white"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">We repair commercial dumpster gates throughout <Link href="/installation/georgia/atlanta-fence-installation/" className="text-brand-orange hover:underline">Metro Atlanta</Link> and across Georgia. Fast scheduling for urgent repairs — code enforcement notices and broken gates that won&rsquo;t close get priority. If the enclosure itself needs rebuilding, our <Link href="/installation/georgia/dumpster-enclosure-gates/" className="text-brand-orange hover:underline">dumpster enclosure installation</Link> team handles new construction as well.</p>
          <p className="text-lg text-gray-700 mb-4">Serving commercial properties in:</p>
          ...
          <div className="space-y-3">
            ...
            <Link href="/installation/georgia/dumpster-enclosure-gates/" className="block text-brand-orange hover:underline font-medium">&rarr; Dumpster Gate Installation in Georgia</Link>
