...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Fence Repair", "item": "https://fenceworkshop.com/installation/georgia/fence-repair/" },
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Commercial Chain Link Fence Repair",
  "description": "Fast commercial chain link fence repair throughout Metro Atlanta and Georgia — fabric replacement, post repair, storm damage, vehicle impact.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
  ...
  "serviceType": "Chain Link Fence Repair"
}
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto"><div className="aspect-[16/7] relative bg-gray-200"><Image src="/images/chain-link-fence-repair-atlanta-ga.jpg" alt="Commercial chain link fence repair by Fence Workshop in Georgia" fill className="object-cover" /></div></div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Chain Link Fence Repair Projects in Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Fabric replacement, post repair, gate service, and security upgrades across Metro Atlanta and Georgia.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { src: '/images/security-fence-repair-atlanta-ga.jpg', alt: 'Commercial security fence repair in Atlanta Georgia' },
              ...
              { src: '/images/commercial-chain-link-fence-atlanta-ga.jpg', alt: 'Commercial chain link fence perimeter in Atlanta Georgia' },
              ...
              { src: '/images/commercial-chain-link-fence-installation-atlanta-ga.jpg', alt: 'Commercial chain link fence installation in Atlanta Georgia' },
            ].map((img) => (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Industrial facilities, property managers, and contractors throughout Georgia trust Fence Workshop for fast, reliable chain link fence repair.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: "A truck backed into our perimeter fence and took out 40 feet of chain link and two posts. Fence Workshop had someone out within 48 hours and the repair was done in a day. You couldn't tell it had ever been hit.", name: "Kevin B.", role: "Warehouse Supervisor, Duluth GA" },
              { quote: "We called on a Friday about storm damage to our school perimeter fence. Fence Workshop had it temporarily secured the same day and fully repaired by Monday morning before school started. Impressive response time.", name: "Linda P.", role: "Facilities Director, Gwinnett County GA" },
              { quote: "We manage three commercial properties and Fence Workshop is our go-to for chain link repairs. They're always fast, the pricing is fair, and they don't cut corners on the posts.", name: "Trevor M.", role: "Property Manager, Norcross GA" },
            ].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every chain link repair we complete is backed by our workmanship guarantee. We test the fence line before we leave — proper tension, post plumb, and gate operation. If anything we repaired fails, we come back and fix it. No runaround.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="quote" className="py-20 bg-white"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">We repair commercial chain link fencing throughout <Link href="/installation/georgia/atlanta-fence-installation/" className="text-brand-orange hover:underline">Metro Atlanta</Link> and across Georgia. Emergency response available for security-critical situations. When repair isn't enough, we also handle full <Link href="/installation/georgia/commercial-chain-link-fence/" className="text-brand-orange hover:underline">commercial chain link fence installation</Link> — same crew, same standards.</p>
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
          <QuoteForm subject="Chain Link Fence Repair Service Request" />
        </div>
      </div></div></section>
