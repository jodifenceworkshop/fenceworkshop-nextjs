...
const serviceSchema = {
  ...
  "@type": "Service",
  "name": "Ornamental Aluminum Fence Installation",
  "description": "Professional commercial ornamental and aluminum fence installation throughout Metro Atlanta and Georgia.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
