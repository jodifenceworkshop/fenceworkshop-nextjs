...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Parking Garage Fencing & Barrier Installation",
  "description": "Professional parking garage fencing, cable railing systems, vehicle barriers, and guard rail installation throughout Metro Atlanta and Georgia.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
  ...
  "serviceType": "Parking Garage Fencing Installation"
}
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto"><div className="aspect-[16/7] relative bg-gray-200"><Image src="/images/parking-deck-fencing-atlanta-ga.jpg" alt="Parking garage cable railing and barrier system installed by Fence Workshop in Georgia" fill className="object-cover" /></div></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Parking structure owners, property managers, and general contractors throughout Georgia trust Fence Workshop for garage barrier and railing systems.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: "We had a cable railing system fail inspection at our parking deck. Fence Workshop came out, assessed the system, and had it replaced and re-inspected within two weeks. They understood the IBC requirements and didn't need to be walked through it.", name: "Brian F.", role: "Facilities Director, Atlanta GA" },
              { quote: "Our hospital parking garage needed vehicle barrier upgrades across three levels. Fence Workshop coordinated with our general contractor, worked around active parking operations, and finished on schedule. Impressive project management.", name: "Lisa O.", role: "VP of Facilities, Decatur GA" },
              { quote: "We manage several mixed-use developments with structured parking. Fence Workshop is our go-to for cable railing and barrier work. Consistent quality, they know the code requirements, and they show up when they say they will.", name: "Kevin T.", role: "Real Estate Developer, Buckhead GA" },
            ].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every parking garage fencing and barrier system we install is backed by our workmanship guarantee. If any component fails to meet code or perform as installed, we come back and make it right. Code-compliant barrier systems are a life-safety issue — we take that seriously on every project.</p>
            </div>
          </div>
        </div>
      </section>
