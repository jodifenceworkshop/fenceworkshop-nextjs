...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Are you a fence repair company near me in Georgia?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Fence Workshop is a commercial fence repair company based in Atlanta, GA serving Metro Atlanta and all of Georgia. We repair chain link fencing, dumpster enclosure gates, roll gates and slide gates, security fencing, and bollards. Service area includes Atlanta, Marietta, Alpharetta, Roswell, Sandy Springs, Smyrna, Kennesaw, Decatur, Duluth, Norcross, Johns Creek, Woodstock, and surrounding communities. Call (404) 314-4419 to schedule a repair." } }
  ]
}
...
const repairServices = [
  ...
  },
  {
    ...
    imageAlt: 'Yellow steel bollard repair and replacement in Georgia',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="space-y-8">
            {[
              ...
              { question: 'Are you a fence repair company near me in Georgia?', answer: 'Yes. Fence Workshop is a commercial fence repair company based in Atlanta, GA serving Metro Atlanta and all of Georgia. We repair chain link fencing, dumpster enclosure gates, roll gates and slide gates, security fencing, and bollards. Service area includes Atlanta, Marietta, Alpharetta, Roswell, Sandy Springs, Smyrna, Kennesaw, Decatur, Duluth, Norcross, Johns Creek, Woodstock, and surrounding communities. Call (404) 314-4419 to schedule a repair.' },
            ].map((faq) => (
