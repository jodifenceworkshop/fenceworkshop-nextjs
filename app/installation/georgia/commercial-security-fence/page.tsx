        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto">
            <div className="aspect-[16/7] relative bg-gray-200">
              <Image
                src="/images/commercial-security-fence-atlanta-ga.jpg"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Commercial Security Fence Projects in Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">High-security perimeter fencing, mesh panel systems, and custom gates installed for commercial and industrial facilities across Georgia.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { src: '/images/custom-black-mesh-panel-fence-product-georgia.jpg', alt: 'Custom black mesh panel fence panels installed in Georgia' },
              { src: '/images/tall-perimeter-security-fence-airport-georgia.jpg', alt: 'Tall perimeter security fence near airport in Georgia' },
              { src: '/images/commercial-perimeter-security-fence-airport-georgia.jpg', alt: 'Commercial perimeter security fence at airport facility in Georgia' },
              { src: '/images/security-perimeter-fence-surveillance-camera-georgia.jpg', alt: 'Security perimeter fence with surveillance camera in Georgia' },
            ].map((img) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <QuoteForm subject="Commercial Security Fence Quote" />
            </div>
          </div>
        </div>
      </section>
