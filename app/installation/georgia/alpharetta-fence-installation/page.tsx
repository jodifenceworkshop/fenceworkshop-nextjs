...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Commercial Fence Installation in Alpharetta, GA",
  "description": "Commercial and industrial fence installation throughout Alpharetta and North Fulton County, GA — chain link, security, ornamental, gate systems, and fence repair. Licensed and insured with 15+ years experience.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="flex-grow">
              ...
              <p className="text-white/90 text-lg">Every fence and gate installation we complete in Alpharetta is backed by our workmanship guarantee. If anything we installed doesn&rsquo;t perform correctly, we come back and make it right — no exceptions.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <QuoteForm subject="Commercial Fence Installation Quote - Alpharetta" />
            </div>
          </div>
        </div>
      </section>
