    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 rounded-xl overflow-hidden shadow-lg max-w-4xl mx-auto"><div className="aspect-[16/7] relative bg-gray-200"><Image src="/images/roll-gate-repair-atlanta-ga.jpg" alt="Commercial roll gate and slide gate repair by Fence Workshop in Georgia" fill className="object-cover" /></div></div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Roll Gate & Slide Gate Repair Projects in Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Track repairs, operator service, frame straightening, and full gate replacements for commercial roll and slide gates throughout Metro Atlanta.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { src: '/images/commercial-roll-gate-installation-atlanta-ga.jpg', alt: 'Commercial roll gate installation in Atlanta Georgia' },
      ...
      <section id="quote" className="py-20 bg-white"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">We repair commercial roll gates and slide gates throughout <Link href="/installation/georgia/atlanta-fence-installation/" className="text-brand-orange hover:underline">Metro Atlanta</Link> and across Georgia. Fast response for gates that are stuck or non-operational. When the gate is beyond repair, our <Link href="/installation/georgia/slide-gates/" className="text-brand-orange hover:underline">slide gate installation</Link> team handles full replacements including new operators and access control.</p>
          <p className="text-lg text-gray-700 mb-4">Serving commercial properties throughout Metro Atlanta including:</p>
              ...
              <div className="space-y-3">
                ...
                <Link href="/installation/georgia/slide-gates/" className="block text-brand-orange hover:underline font-medium">&rarr; Commercial Slide Gate Installation in Georgia</Link>
        ...
        <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
          ...
          <QuoteForm subject="Roll Gate & Slide Gate Repair Service Request" />
        </div>
      </div></div></section>
