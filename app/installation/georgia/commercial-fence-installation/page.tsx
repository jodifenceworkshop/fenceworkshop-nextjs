        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              ...
              <Link href="/installation/georgia/fence-repair/" className="text-brand-orange hover:underline">View all commercial fence repair services →</Link>
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/installation/georgia/residential-fence-installation/" className="block text-brand-orange hover:underline font-medium">
            ...
            <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
              <QuoteForm subject="Commercial Fence Installation Quote" />
            </div>
          </div>
        </div>
      </section>
