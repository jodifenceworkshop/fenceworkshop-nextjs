...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Security Gate Systems & Access Control Installation",
  "description": "Professional security gate systems and access control installation for commercial and industrial facilities throughout Metro Atlanta and Georgia.",
  "provider": {
    "@type": "LocalBusiness",
    "name": "Fence Workshop",
  ...
  "serviceType": "Security Gate System Installation"
}
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Security Gate System Projects in Georgia</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Automated swing gates, cantilever gates, and access control systems installed for commercial facilities throughout Metro Atlanta.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { src: '/images/chain-link-slide-gate-operator-barbed-wire-georgia.jpg', alt: 'Chain link slide gate with operator and barbed wire security fence in Georgia' },
              ...
              { src: '/images/chain-link-double-swing-gate-commercial-georgia.jpg', alt: 'Chain link double swing gate at commercial property in Georgia' },
              { src: '/images/black-chain-link-double-swing-gate-atlanta-ga.jpg', alt: 'Black chain link double swing gate in Atlanta Georgia' },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Property managers and facility directors across Metro Atlanta trust Fence Workshop for reliable security gate and access control installations.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "Fence Workshop handled our entire gate system upgrade — new slide gate, operator, and card reader integration. The crew was professional and the system has worked flawlessly since day one. Response time on the quote was fast and the installation came in on schedule.",
                name: "Marcus T.",
                role: "Facilities Director, Smyrna GA"
              },
              {
                quote: "We needed a UL 325-compliant gate operator installed quickly for an insurance deadline. Fence Workshop came out, assessed the situation, and had it installed within the week. They knew exactly what was needed and handled the whole thing without hand-holding.",
                name: "Denise R.",
                role: "Property Manager, Alpharetta GA"
              },
              {
                quote: "Our industrial yard gate had been a problem for years. Fence Workshop replaced it with a heavy-duty cantilever slide gate and a commercial operator. Zero issues since. I wish we had called them sooner.",
                name: "Kevin P.",
                role: "Operations Manager, Norcross GA"
              },
            ].map((t) => (
      ...
      <section id="quote" className="py-20 bg-gray-100"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">We install and service commercial security gate systems and access control throughout <Link href="/installation/georgia/atlanta-fence-installation/" className="text-brand-orange hover:underline">Metro Atlanta</Link> and across Georgia. Gate systems are often paired with new <Link href="/installation/georgia/commercial-fence-installation/" className="text-brand-orange hover:underline">commercial fence installation</Link> — we handle both together so the system is designed and built as one cohesive perimeter.</p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <QuoteForm subject="Security Gate Systems Quote" />
        </div>
      </div></div></section>
