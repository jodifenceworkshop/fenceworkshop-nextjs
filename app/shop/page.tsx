...
export const metadata: Metadata = {
  ...
  description: 'Buy aluminum fences, driveway gates, walk gates, and accessories online from Fence Workshop. Premium materials designed by installers, shipped nationwide.',
}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
              Fence Workshop sells premium aluminum fencing, driveway gates, walk gates, and accessories
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-medium">Free Support on All Orders</span>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-6 h-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section className="py-16 bg-brand-green">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+14043144419"
              className="inline-block bg-white text-brand-green font-semibold px-8 py-4 rounded-lg text-lg hover:bg-gray-100 transition-colors shadow-lg text-center"
            >
              Call (404) 314-4419
            </a>
            <Link
